        ...
        <section className="slide fade-6 kenBurns">
          ...
          <ul className="flex reverse verticalCenter" style={{background: '#ffffff', color: 'green'}}>
            ...
            <Link to="/"><span className="fa fa-arrow-left" style={{color: 'green', fontSize: '30px', marginBottom: '1em'}}></span></Link>
              <h3 className="ae-1">About KnowNigeria</h3>
              <div className="ae-2 center fromLeft">
                  <img src="logo" style={{height: '100px', width: '100px'}} alt="Logo of the State" align="center" />
                <p className="opacity-8" style={{fontSize: '13px', textAlign: 'justify', marginBottom: '5px'}}>
                  Know Nigeria is a platform developed to help give basic information about Nigeria. It provides relative and key information for all Nigerian State. It is light-weight, and very easy to use.
                </p>
                <p  className="opacity-8" style={{fontSize: '13px', textAlign: 'justify', marginBottom: '5px'}}>
                Know Nigeria aims to help Students, Researchers, Foreigners and Nationals in their research about the country.
                </p>
              </div>
            </li>
            </ul>
